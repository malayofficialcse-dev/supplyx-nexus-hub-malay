        ...
        try {
            ...
            for (let i = 11; i >= 0; i--) {
                ...
                monthlyTrend.push({
                    ...
                    value: monthOrders.reduce((s, o) => s + Number(o.amount ?? 0), 0),
            ...
            if (orders.length > 0) {
                const reqDates = requisitions.map((r) => new Date(r.createdAt).getTime());
                const ordDates = orders.map((o) => new Date(o.createdAt ?? now).getTime());
            ...
            const result = {
                ...
                supplierRisk,
                summary: {
                    totalPOSpend: orders.reduce((s, o) => s + Number(o.amount ?? 0), 0),
                    totalInvoiced,
